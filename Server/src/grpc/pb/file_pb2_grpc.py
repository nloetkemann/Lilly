...
class FileStub(object):
  ...
  def __init__(self, channel):
    ...
    self.UploadFile = channel.stream_unary(
        ...
        response_deserializer=src_dot_grpc_dot_pb_dot_message__pb2.Empty.FromString,
        )
...
def add_FileServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'UploadFile': grpc.stream_unary_rpc_method_handler(
          ...
          response_serializer=src_dot_grpc_dot_pb_dot_message__pb2.Empty.SerializeToString,
      ),
  }
